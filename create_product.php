                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input name="product_name" id="product_name" type="text"
                                class="border w-100 p-2 bg-white text-capitalize" placeholder="Product title goes here">
                            ...
                            <textarea name="product_description" id="product_description" class="border p-3 w-100"
                                rows="7" placeholder="Write details about your product"></textarea>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <center><button name="submit_button" id="btn_submit" type="submit"
                                    class="btn btn-primary d-block mt-2">Post Your Product</button></center>
                        </div>
                    </div>
                </fieldset>
                <!-- Post Your ad end -->
