                    ...
                    <div class="product-details">
                        ...
                        <div class="product-meta">
                            <ul class="list-inline">
                                <li class="list-inline-item"><i class="fa fa-user-o"></i> By <a
                                        href=""><?php echo $row1['artist']; ?></a></li>
                            </ul>
                        </div>
                        <br>
                        ...
                        <div>
                            <div class="product-slider-item">
                                <img class="img-fluid w-100" src="database_images/<?php echo $row1['picture']; ?>"
                                    alt="product-img">
                            </div>
                ...
                <div class="col-md-4">
                    <div class="sidebar">
                        ...
                        <div class="widget user text-center">
                            <img class="rounded-circle img-fluid mb-5 px-5" src="database_images/profile_pic.png"
                                alt="">
                        ...
                        <div class="widget rate">
                            <form method="POST" action="edit_product.php?pid=<?php echo $_GET['pid']; ?>">
                                <h5 class="widget-header text-center">Edit Product</h5>
                                <div>
