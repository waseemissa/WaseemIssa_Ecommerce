                    ...
                    <nav class="navbar navbar-expand-lg navbar-light navigation">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ml-auto mt-10">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white add-button" href="register.php"><i
                                    ...
                                    <form method="POST" action="search.php">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <input type="text" class="form-control my-2 my-lg-1" id="item_name"
                                                    name="name" placeholder="What are you looking for">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="text" class="form-control my-2 my-lg-1"
                                                    id="description_text" name="description" placeholder="Details">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="text" class="form-control my-2 my-lg-1" id="artist_name"
                                                    name="artist" placeholder="Artist">
                                            </div>
                                            <div class="form-group col-md-2 align-self-center">
                                                <button name="submit" type="submit" class="btn btn-primary">Search
                                                    Now</button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="thumb-content">
                                <a href="display_product.php?pid=<?php echo $row1['id']; ?>">
                                    <img class="card-img-top img-fluid"
                                        src="<?php echo "database_images/".$row1['picture']; ?>" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body">
