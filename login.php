        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-8 align-item-center">
                    <div class="border">
                        <h3 class="bg-gray p-4">Customer Login</h3>
                        <form action="php/login.php" method="POST">
                            ...
                            ?>
                                ...
                                <button id="btn-submit" name="submit_button" type="submit"
                                    class="d-block py-3 px-5 bg-primary text-white border-0 rounded font-weight-bold mt-3">Log
                                    in</button>
                                <a class="mt-3 d-inline-block text-primary" href="register.php">Don't have an account?
                                    Create one!</a>
                            </fieldset>
                        </form>
                    </div>
