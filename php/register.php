...
if(!empty($row1)){
    ...
    $query2 = "INSERT INTO users(first_name, last_name, email, phone_number, address, date_of_birth, password) VALUES (?,?,?,?,?,?,?)";
    $stmt2 = $connection->prepare($query2);
    $stmt2->bind_param("sssssss", $first_name, $last_name, $email, $phone_number, $address, $final_date, $hashed_password);
    $stmt2->execute();
