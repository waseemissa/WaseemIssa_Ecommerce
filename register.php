                    ...
                    <div class="border">
                        ...
                        <form id="register_form" action="php/register.php" method="POST">
                            <div class="row" style="padding: 10px;">
                                <div class="col-md-6">
                                    <input required name="first_name" id="first_name" type="text"
                                        placeholder="First Name" class="border p-3 w-100 my-2">
                                </div>
                                <div class="col-md-6">
                                    <input required name="last_name" id="last_name" type="text" placeholder="Last Name"
                            ...
                            <div class="row" style="padding: 10px;">
                                ...
                                <div class="col-md-6">
                                    <input required name="date_of_birth" id="date_of_birth" type="text"
                                        placeholder="Date of Birth" class="border p-3 w-100 my-2">
                                </div>
                            </div>
                            ...
                            <button name="submit_button" id="btn-submit" type="submit"
                                ...
                                Up</button>
                            <a class="mt-3 d-inline-block text-primary" href="login.php">already have an account? Login
                                instead.</a>
                ...
                <div class="col-md-8">
                    <div class="content-holder">
                        ...
                        <ul class="list-inline mt-30">
                            <li class="list-inline-item"><a class="btn btn-main" href="store_register.php">Sign Up</a>
                            </li>
                            <li class="list-inline-item"><a class="btn btn-secondary" href="store_login.php">Login</a>
                            </li>
                        </ul>
                    </div>
                </div>
