...
//get products
$query1 = "SELECT p.name AS name, p.description AS description, p.artist AS artist, p.picture as picture, sum(up.amount) as amount FROM products AS p, users_buy_products AS up 
 WHERE up.user_id= ? AND up.product_id = p.id 
    ...
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              <li><a href="user_homepage.php"><i class="fa fa-user"></i> All Products</a></li>
              <li class="active"><a href="#"><i class="fa fa-bookmark-o"></i>Cart
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">My Purchases</h3>
                ...
                <td class="action" data-title="Action">
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      <li class="list-inline-item"><?php echo $row1['amount'];?></li>
                    </ul>
                  </div>
                </td>
              </tr>
