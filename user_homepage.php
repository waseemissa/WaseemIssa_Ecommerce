        ...
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            ...
            <li><a href="php/logout.php"><i class="fa fa-cog"></i> Logout</a></li>
              <li><a href="php/delete_user_account.php?uid=<?php echo $_SESSION['user_id']; ?>" ><i class="fa fa-power-off"></i>Delete Account</a></li>
            </ul>
          </div>
                ...
                <td class="action" data-title="Action">
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      ...
                      <button class="edit like" style="color: red; height: 41px; width: 41px; border:none; border-radius: 50%; " name="like" id="like" data-toggle="tooltip" data-placement="top" title="Like" value="<?php echo $row1['id']; ?>">
                      <i class="fa fa-heart"></i>
                      </button>
                        <a data-toggle="tooltip" data-placement="top" title="view" class="view" href="display_product_for_client.php?pid=<?php echo $row1['id']; ?>">
                          <i class="fa fa-eye"></i>
                        </a>
                      <button class="edit add_to_cart" style="color: cyan; height: 41px; width: 41px; border:none; border-radius: 50%; " name="add_to_cart" id="add_to_cart" data-toggle="tooltip" data-placement="top" title="Add To Cart" value="<?php echo $row1['id']; ?>">
